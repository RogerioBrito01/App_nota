...
import 'package:mynote/feature/domain/use_cases/add_new_note_usecase.dart';
import 'package:mynote/feature/domain/use_cases/delete_note_usecase.dart';
import 'package:mynote/feature/domain/use_cases/get_notes_usecase.dart';
import 'package:mynote/feature/domain/use_cases/update_note_usecase.dart';
...
class NoteCubit extends Cubit<NoteState> {
  ...
  NoteCubit({required this.getNotesUseCase,required this.deleteNoteUseCase,required this.addNewNoteUseCase, required this.upDateNoteUseCase}) : super(NoteInitial());
